...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/delicate-wave-e6e6
```

A live public deployment of this template is available at [https://delicate-wave-e6e6.templates.workers.dev](https://delicate-wave-e6e6.templates.workers.dev)
